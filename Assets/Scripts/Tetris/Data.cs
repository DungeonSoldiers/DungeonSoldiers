...
{
    // Variável com o cosseno
    public static readonly float cos = Mathf.Cos(Mathf.PI / 2f);
    // Variável com o seno
    public static readonly float sin = Mathf.Sin(Mathf.PI / 2f);
    // Lista com o cosseno e o seno positivo e negativo que será utilizado na rotação do "Tetromino"
    public static readonly float[] RotationMatrix = new float[] { cos, sin, -sin, cos };

    // Lista com todas as posições de cada célula dos "Tetrominoes"
    ...
    // Lista com os valores dos testes de "wall kicks" para a figura I
    ...
    // Lista com os valores dos testes do "wall kicks" para as outras figuras
    ...
    // Lista utilizada para associar os "Tetrominoes" com os seus testes de "wall kicks"
